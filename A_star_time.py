...
def a_star_time(graph, heuristic, start, goal, vehicles, requests, request_id):
    """
        ...
        if len(traject) > 1 and np.abs(traject[-1] - traject[-2]) != 10 and np.abs(traject[-1] - traject[-2]) != 20:
            if traject[-1] < 10:
                ...
                for v in range(len(vehicles)):
                    if vehicles[v][8] == origin and vehicles[v][9] == destination and vehicles[v][7] == 1 and vehicles[v][0] and vehicles[v][10] >= current_time:
                ...
                for v in range(len(vehicles)):
                    if vehicles[v][8] == origin and vehicles[v][9] == destination and vehicles[v][7] == 2 and vehicles[v][0] and vehicles[v][10] >= current_time:
                        used_vehicles.append(vehicles[v][0])
                        current_time = vehicles[v][12]
                        break
                ...
                for v in range(len(vehicles)):
                    if vehicles[v][8] == origin and vehicles[v][9] == destination and vehicles[v][7] == 3 and vehicles[v][0]:
                        used_vehicles.append(vehicles[v][0])
